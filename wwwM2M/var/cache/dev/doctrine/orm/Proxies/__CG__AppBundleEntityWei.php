...
class Wei extends \AppBundle\Entity\Wei implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'nickname', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'lastreport', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'imei', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'operator', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'activationdate', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'modificationdate', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'chipnumber', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'idwei', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'locationlocation', '' . "\0" . 'AppBundle\\Entity\\Wei' . "\0" . 'customercustomer'];
        }
    ...
    public function setCustomercustomer(\AppBundle\Entity\Customer $customercustomer = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomercustomer', [$customercustomer]);

        return parent::setCustomercustomer($customercustomer);
    }
    ...
    public function getCustomercustomer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomercustomer', []);

        return parent::getCustomercustomer();
    }
