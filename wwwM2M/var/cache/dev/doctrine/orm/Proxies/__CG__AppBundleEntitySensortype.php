...
class Sensortype extends \AppBundle\Entity\Sensortype implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'standard', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'minvalue', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'maxvalue', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'idsensortype', '' . "\0" . 'AppBundle\\Entity\\Sensortype' . "\0" . 'measurement'];
        }
